...
const SettingsPage = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto text-sm text-white font-mono">
      <h1 className="text-2xl mb-4 font-bold">Obi-Watch-Kenobi</h1>
      <div className="flex gap-4 text-pink-400 mb-6">
        <span>[ General ]</span>
        <span>[ Alerts ]</span>
        <span>[ Integrations ]</span>
        <span>[ Automation ]</span>
        <span>[ Security ]</span>
        <span className="ml-auto text-blue-400 cursor-pointer">[ Save Settings ]</span>
      </div>
      ...
      <section className="mb-6 border border-gray-700 p-4 rounded">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>Time Zone: 
            <select className="ml-2 bg-[#ffffff1e] text-white border border-gray-600"
      ...
      <section className="mb-6 border border-gray-700 p-4 rounded">
        ...
        <div className="space-y-2">
          ...
          <div>
            Severity Threshold:
            <select
              className="ml-2 bg-[#ffffff1e] text-white border border-gray-600"
      ...
      <section className="mb-6 border border-gray-700 p-4 rounded">
        ...
        <div className="space-y-2">
          <div>
            ...
            <input
              type="text"
              className="ml-2 w-full bg-[#ffffff1e] text-white border border-gray-600"
          ...
          <div>
            ...
            <input
              ...
              placeholder="PDSVC-xxxxxxxxxxxxxxxxxxxxxxx"
            />
          </div>
        </div>
      </section>
      ...
      <section className="mb-6 border border-gray-700 p-4 rounded">
        ...
        <div className="space-y-2">
          ...
          <div>
            ...
            <input
              type="number"
              className="ml-2 w-20 bg-[#ffffff1e] text-white border border-gray-600"
